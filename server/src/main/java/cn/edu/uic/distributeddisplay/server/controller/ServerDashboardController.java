...
import cn.edu.uic.distributeddisplay.server.util.ColorfulListRenderer;
...
//        updateFields();
    ...
    private void initMainWindowInfoPanel() {
        ...
        ClientListPanel clientListPanel = serverMainWindowView.getNodeListPanel();
        ...
        JTable nodeListTable = clientListPanel.getNodeListTable();
        ...
        clientListPanel.getAddNodeButton().addActionListener(e -> {
            clientListPanel.getAddNodeButton().setEnabled(false);
            clientListPanel.getNewNodeNameTextField().setEnabled(false);

            String newNodeName = clientListPanel.getNewNodeNameTextField().getText();
            if (Objects.equals(newNodeName, "")) {
                ...
                clientListPanel.getNewNodeNameTextField().setText("");
            ...
            clientListPanel.getNewNodeNameTextField().setEnabled(true);
            clientListPanel.getAddNodeButton().setEnabled(true);
        });

        clientListPanel.getDeleteNodeButton().addActionListener(e -> {
            clientListPanel.getDeleteNodeButton().setEnabled(false);
            ...
            clientListPanel.getDeleteNodeButton().setEnabled(true);
        });
    ...
    public void previewBtnClicked() {
        ...
        SwingUtilities.invokeLater(() -> {
            new ServerDisplayController(serverSideProfile);
        });
        ServerViewsManager.getMainWindowView().setVisible(false);
    }
