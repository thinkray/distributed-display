...
//            ProfileManager.setProfile(new ServerSideProfile());
//        } else {
//            try {
//                read();
...
//    }
//
//    public void save(ServerSideProfile serverSideProfile) throws IOException{
//        ProfileManager.setProfile(serverSideProfile);  // Register the profile to the profile manager
//        // Write the profile
//        FileOutputStream fos = new FileOutputStream(profileDirectory);
//        ObjectOutputStream out = new ObjectOutputStream(fos);
//        out.writeObject(serverSideProfile);
//        out.close();
//        fos.close();
...
//        ProfileManager.setProfile((ServerSideProfile)in.readObject());
//        in.close();
//        fis.close();
